        ...
        let handleInput = function(x) {
		  ...
		  document.getElementById("demo2").innerHTML = "correct answer"
               // note.innerHTML = 'Correct! <a href=smilel2.php><button class="buttoninfo"  >Next level?</button> </a> ';
				document.getElementById("classenter").innerHTML ='<h1 style="color: white;background-color: #CE4FA2;">you won!!Save your marks</h1><a href="SmileGameL2.php"><button class="butnNextlevel"  >Next level?</button> </a> ';
